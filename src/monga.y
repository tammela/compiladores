...
def-var : TK_ID ':' type ';'    { $$ = vardefNode($1, $3); }
        ;
...
def-function : TK_ID '(' parameters ')' ':' type statement { $$ = funcdefNode(varNode($1, $6), $3, $7); }
             ;
...
parameter : TK_ID ':' type { $$ = vardefNode($1, $3); }
          ;
...
var : TK_ID                             { $$ = refvNode(varNode($1, NULL)); }
...
func-call : TK_ID '(' list-exp ')' { $$ = callNode($1, $3); }
          ;
